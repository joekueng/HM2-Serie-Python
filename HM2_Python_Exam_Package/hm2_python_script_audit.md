...
| Kap.5 Newton 1D | Nullstelle einer Funktion mit Newton | OK | `Nichtlineare_Gleichung_newton_1d.py` |
...
| FS25/Aufgabe 4 | Newton ohne Daempfung per minimo, grad g = 0, contour f1/f2 | OK | `Newton_minimum_contour.py`, `exam/Aufgabe4_newton_minimum.py`, `Scripts/Kapitel_5/Newton_minimum_contour.py` |
...
| S5 Aufg2-3 | natural cubic spline + SciPy comparison + polyfit | OK | `Interpolation_spline_natuerlich.py`, `Interpolation_spline_randbedingungen.py`, `Scripts/Kapitel_6/Spline_natuerlich*.py` |
...
| S6 Aufg2 | linear LS multivariate vapour data | OK | `Ausgleichsrechnung_linear.py`, `Scripts/Kapitel_6/Ausgleichsrechnung_linear.py` |
| S6 linearized | linearized fit, log/semilogy transformed data | OK | `Ausgleichsrechnung_linearisiert.py`, `Scripts/Kapitel_6/Ausgleichsrechnung_linearisiert.py` |
...
| S8 Aufg3 | non-equidistant trapezoid + earth mass | OK | `Integration_trapez_tabelle_nichtaequidistant.py`, `Scripts/Kapitel_7/Integration_trapez_erde.py` |
...
| S12 | RK4 + custom RK + method comparison/errors | OK | `DGL_rk4_euler_mod.py`, `DGL_runge_kutta_butcher_ordnung.py`, `DGL_rakete_rk4_vs_euler_mod.py`, `DGL_methodenvergleich.py`, `DGL_rk4_vs_custom.py` |
...
6. Aggiunto `00_HM2_EXAM_SEARCH_INDEX.py` come indice locale cercabile per famiglie di esercizi.
7. Aggiunti template top-level per Newton 1D e spline con boundary conditions (`natural`, `not-a-knot`, `clamped`, `periodic`).
8. Promossi nel top-level anche Ausgleich lineare/linearizzato, trapez su tabella non equidistante, integrazione cumulativa e confronto DGL/RK.
...
- `Ausgleichsrechnung_linear.py` = `Scripts/Kapitel_6/Ausgleichsrechnung_linear.py`
- `Ausgleichsrechnung_linearisiert.py` = `Scripts/Kapitel_6/Ausgleichsrechnung_linearisiert.py`
- `Integration_trapez_tabelle_nichtaequidistant.py` = `Scripts/Kapitel_7/Integration_trapez_erde.py`
- `Integration_rakete_kumulativ.py` = `Scripts/Kapitel_7/Integration_rakete_kumulativ.py`
- `DGL_methodenvergleich.py` = `Scripts/Kapitel_8/DGL_methodenvergleich.py`
...
- `DGL_rk4_vs_custom.py` = `Scripts/Kapitel_8/DGL_rk4_vs_custom.py`
